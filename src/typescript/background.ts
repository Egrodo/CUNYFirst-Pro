...
async function sendProfList(ratingsRequest: ratingsRequest, tabId: number) {
...
const onMessage = ({ratingsRequest}, sender): void => {
  sendProfList(ratingsRequest, sender.tab.id);
};
